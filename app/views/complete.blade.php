        ...
        <div class="col-md-9">
            ...
            {{ Form::open(array('url' => getLang().'quiz/complete','id'=>'form-email-report','class'=>'clearfix form-horizontal')) }}
                ...
                <div class="form-group{{$errors->has('fname')?' error has-error':''}}">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="req form-control" name="fname" placeholder="{{Lang::get('general.fname')}}" value="{{$source['C_FirstName']?$source['C_FirstName']:''}}">
                        <span>{{Lang::get('general.errorFname')}}</span>
                    </div>
                    
                </div>
                <div class="form-group{{$errors->has('sname')?' error has-error':''}}">
                    <label for="sname" class="col-sm-2 control-label">{{Lang::get('general.sname')}} *</label>
                    <div class="col-sm-10">
                        <input type="text" class="req form-control" name="sname" placeholder="{{Lang::get('general.sname')}}" value="{{$source['C_LastName']?$source['C_LastName']:''}}">
                        <span>{{Lang::get('general.errorSname')}}</span>
                    </div>
                    
                </div>
                <div class="form-group{{$errors->has('email')?' error has-error':''}}">
                    <label for="email" class="col-sm-2 control-label">{{Lang::get('general.email')}} *</label>
                    <div class="col-sm-10">
                        <input type="email" class="req form-control email" name="email" placeholder="{{Lang::get('general.email')}}" value="{{$source['C_emailAddress']?$source['C_emailAddress']:''}}">
                        <span>{{Lang::get('general.errorEmail')}}</span>
                    </div>
                    
                </div>
                <div class="form-group{{$errors->has('company')?' error has-error':''}}">
                    <label for="email" class="col-sm-2 control-label">{{Lang::get('general.company')}} *</label>
                    <div class="col-sm-10">
                        <input type="text" class="req form-control" name="company" placeholder="{{Lang::get('general.company')}}" value="{{$source['C_Company']?$source['C_Company']:''}}">
                        <span>{{Lang::get('general.errorCompany')}}</span>
                    </div>
                    
                </div>
                <div class="form-group{{$errors->has('company')?' error has-error':''}}">
                    <label for="country" class="col-sm-2 control-label">{{Lang::get('general.country')}} *</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group{{$errors->has('phone')?' error has-error':''}}">
                    <label for="phone" class="col-sm-2 control-label">{{Lang::get('general.phone')}}</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="phone" placeholder="{{Lang::get('general.phone')}}" value="{{$source['C_BusPhone']?$source['C_BusPhone']:''}}">
                        <span>{{Lang::get('general.errorNumber')}}</span>
                    </div>
                </div>
                <em class="pull-right"> * {{Lang::get('general.required')}}</em>
                <div class="form-group{{$errors->has('terms')?' error has-error':''}}">
                    <div class="col-sm-offset-2 col-sm-10 checkbox">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" class="req" name="terms"> {{Lang::get('general.accept')}}
                            </label>
                        </div>
                        <span>{{Lang::get('general.errorCheck')}}</span>
                        <aside>
                            <p>
