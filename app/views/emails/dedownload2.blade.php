                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent">
                                                <h1>Hallo {{$fname}},</h1>
                                                <br/>
                                                Wie versprochen senden wir Ihnen den Link zum Download des Berichts zu Ihrer technischen Fitness. Er umfasst eine Aufschlüsselung Ihrer Leistung nach Kategorie und ermöglicht Ihnen den Vergleich mit anderen Unternehmen in EMEA.
                                                <br /><br/>
                                                <a href="{{ URL::asset('http://de.techfitquiz.com/quiz/download/'.$userid) }}" target="_blank"><img src="{{ URL::asset('img/deemail_download.jpg')}}" style="max-width:316px;display:block; margin:0 auto" align="middle"/></a>
                                                <br/><br/>
                                                Nach der Auswertung des Berichts können Sie sich unter <a href="http://hp.com/go/businessready" style="color:#024886">HP Business Ready</a> über Neuigkeiten in Sachen Geschäftstechnologien informieren. Hier eine Auswahl von Artikeln, die Sie interessieren könnten:<br/><br/>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END BODY -->
                                            	...
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="leftColumnContent" height="150">
                                                            <h2>Sicherheit</h2>
                                                            Stellt Ihr Drucker ein Sicherheitsrisiko für vertrauliche Daten dar? 10 bedeutende Risiken von Windows XP<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/Is-your-printer-putting-sensitive-data-at-risk/ba-p/89690#.VI7r8FesV7c" target="_blank"><img src="{{asset('img/deemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            	...
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="rightColumnContent" height="150">
                                                            ...
                                                            Enterprise-Cloud-Computing – Aufklärung häufiger Mythen<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/Enterprise-cloud-computing-myths-debunked/ba-p/91496#.VI7tc1esV7c" target="_blank"><img src="{{asset('img/deemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        	...
                                        	<td align="center" valign="top" class="templateColumnContainer" style="padding-top:20px;">
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="leftColumnContent" height="150">
                                                            <h2>Mobilität</h2>
                                                            Hot-Desking und BYOD-Drucken – Ein Leitfaden<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/BYOD-printing-the-things-to-consider/ba-p/92150#.VI7uWFesV7c" target="_blank"><img src="{{asset('img/deemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        	<td align="center" valign="top" class="templateColumnContainer" style="padding-top:20px;">
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="rightColumnContent" height="150">
                                                            <h2>Big Data</h2>
                                                            5 Vorteile von Big Data für Ihr Kleinunternehmen<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/5-ways-your-small-business-can-benefit-from-big-data/ba-p/92118#.VI7uqVesV7c" target="_blank"><img src="{{asset('img/deemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
