                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent">
                                                ...
                                                <br /><br/>
                                                <a href="{{ URL::asset('http://techfitquiz.com/quiz/download/'.$userid) }}" target="_blank"><img src="{{ URL::asset('img/email_download.jpg')}}" style="max-width:316px;display:block; margin:0 auto" align="middle"/></a>
                                                <br/><br/>
