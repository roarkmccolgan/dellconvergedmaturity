                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent">
                                                <h1>Hola: {{$fname}},</h1>
                                                <br/>
                                                Tal y como prometimos, le facilitamos un enlace para descargar su informe de aptitud tecnológica. Este informe desglosa su rendimiento por categoría y le permite compararse con otras organizaciones que operan dentro de la región de EMEA.
                                                <br /><br/>
                                            	...
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="leftColumnContent" height="150">
                                                            <h2>Seguridad</h2>
                                                            Is your printer putting sensitive data at risk? (¿Su impresora pone en peligro datos confidenciales?) Top 10 dangers of staying on Windows XP (Los 10 peligros principales de tener Windows XP)<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/Is-your-printer-putting-sensitive-data-at-risk/ba-p/89690#.VI7r8FesV7c" target="_blank"><img src="{{asset('img/esemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            	...
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="rightColumnContent" height="150">
                                                            ...
                                                            Enterprise cloud computing myths debunked (Desmontamos los mitos de la informática en la Nube para empresas)<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/Enterprise-cloud-computing-myths-debunked/ba-p/91496#.VI7tc1esV7c" target="_blank"><img src="{{asset('img/esemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        	...
                                        	<td align="center" valign="top" class="templateColumnContainer" style="padding-top:20px;">
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="leftColumnContent" height="150">
                                                            <h2>Movilidad</h2>
                                                            A guide to hot desking BYOD printing: the things to consider (Una guía para la impresión BYOD desde una única estación de trabajo: cosas a tener en cuenta)<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/BYOD-printing-the-things-to-consider/ba-p/92150#.VI7uWFesV7c" target="_blank"><img src="{{asset('img/esemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        	<td align="center" valign="top" class="templateColumnContainer" style="padding-top:20px;">
                                            	<table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                    	<td valign="top" class="rightColumnContent" height="150">
                                                            <h2>Big Data</h2>
                                                            5 ways your small business could benefit from big data (5 formas por las que su empresa podría beneficiarse de Big Data)<br/><br/>
                                                            <a href="http://h20435.www2.hp.com/t5/HP-BusinessReady/5-ways-your-small-business-can-benefit-from-big-data/ba-p/92118#.VI7uqVesV7c" target="_blank"><img src="{{asset('img/esemail_click.jpg')}}" style="max-width:150px;"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter" align="center">
                                        <tr>
                                            <td valign="top" class="footerContent"><br/><br/>
                                                Este correo electrónico se ha generado automáticamente, no responda a este mensaje.<br/>
                                                <a href="{{url('http://es.techfitquiz.com/email', array($userid))}}">Ver en el explorador</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END FOOTER -->
