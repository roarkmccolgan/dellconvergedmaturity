...
<title>Converged Infrastructure d'IDC - Maturité Benchmark</title>
<style>
/* -------------------------------------
		GLOBAL
------------------------------------- */
				...
				<tr>
					<td>
						...
						<table>
							<tr>
								<td class="padding">
									<p><a href="{{ URL::asset('quiz/download/'.$userid) }}" class="btn-primary">Télécharger le rapport</a></p>
								</td>
							</tr>
						</table>
		...
		<td class="container">
			...
			<div class="content">
				<table>
					<tr>
						<td align="center">
							<p>Ne pas aimer ces courriels gênants? <a href="mailto:rmccolgan@idc.com?subject=Please unsubscribe me from the Converged Maturity mail system"><unsubscribe>Se désabonner</unsubscribe></a>.
							</p>
						</td>
					</tr>
				</table>
